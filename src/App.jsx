...
export default function App() {
  // State to control the visibility of the Brochure Modal
      ...
      <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans flex flex-col relative">
        ...
        <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-neutral-200">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <Link to="/" className="text-2xl font-bold tracking-tighter">ASM GLASS</Link>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/products/appliance-glass" className="hover:text-white transition-colors">Appliance Glass</Link></li>
              ...
              <div className="p-8">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <span className="inline-flex items-center px-3 border border-r-0 border-neutral-300 bg-neutral-50 text-neutral-500 rounded-l-lg text-sm">
                        +91
                      </span>
                      <input 
                        type="tel" 
                        placeholder="99999 99999"
                        className="w-full px-4 py-2 border border-neutral-300 rounded-r-lg focus:ring-2 focus:ring-black focus:border-transparent outline-none transition-all"
                      />
                    </div>
                  </div>
                  
                  {/* Note: This button currently just prevents page reload. Backend logic goes here. */}
                  <button 
                    type="submit"
                    className="w-full bg-black text-white py-3 rounded-lg font-semibold hover:bg-neutral-800 transition-colors mt-2"
                  >
